...
ln -sf /secrets/ssl/it-dev.openshift.dsc.umich.edu.cert /etc/ssl/certs/it-dev.openshift.dsc.umich.edu.cert
ln -sf /secrets/ssl/it-dev.openshift.dsc.umich.edu.key /etc/ssl/private/it-dev.openshift.dsc.umich.edu.key
